...
## Deployment Command
```bash
rm -f A.N-Resources-Website.zip && zip -r A.N-Resources-Website.zip index.html about.html services.html process.html contact.html contact.php site.webmanifest MEMORY.md .gemini/memory.md CLAUDE.md assets .htaccess
```
